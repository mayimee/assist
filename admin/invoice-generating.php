          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading">Official Invoice</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title">Please settle your balance upon receipt of this invoice.</h3>
...
{               ?>
  ...
  <tr>
    ...
    <th>Date Service Rendered</th>
    <td><?php  echo $row->EventDate;?></td>
  </tr>
 

  <tr>
    <th style="text-align: center;" colspan="2">Service</th>
...
<p >
      <input name="Submit2" type="submit" class="txtbox4" value="Close" onClick="location.href='approved-booking.php'" style="cursor: pointer;"  />   <input name="Submit2" type="submit" class="txtbox4" value="Print" onClick="return f3();" style="cursor: pointer;"  /></p>
