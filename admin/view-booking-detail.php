...
<head>
  ...
  <title>Assist - View Booking</title>
  ...
  <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed main-content-narrow">
    ...
    <main id="main-container">
      ...
      <div class="content">
        ...
        <!-- Register Forms -->
        <h2 class="content-heading">Booking Details</h2>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="block block-themed">                              
              <div class="block-content">
                ...
                <table border="1" class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                  ...
                  <tr>
                    ...
                    <td><?php echo "Not yet updated"; ?></td>
              ...
              <button class="btn btn-secondary waves-effect waves-light w-lg"><a href="new-booking.php">Back</a></button></p>  
