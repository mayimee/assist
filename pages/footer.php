    ...
    <div class="footerServices">
        <div class="footerServicesColumn">
            <ul class="footerServicesBullets">
                <li><span class="footerBoldTextServices">CLEANING & MAINTENANCE</span></li>
        ...
        <div class="footerServicesColumn">
            <ul class="footerServicesBullets">
                <li><span class="footerBoldTextServices">CONSTRUCTION</span></li>
        ...
        <div class="footerServicesColumn">
            <ul class="footerServicesBullets">
                <li><span class="footerBoldTextServices">COMPUTER REPAIR & MAINTENANCE</span></li>
        ...
        <div class="footerServicesColumn">
            <ul class="footerServicesBullets">
                <li><span class="footerBoldTextServices">APPLIANCE REPAIR</span></li>
        ...
        <div class="footerServicesColumn">
            <ul class="footerServicesBullets">
                <li><span class="footerBoldTextServices">EVENTS</span></li>
        ...
        <div class="footerServicesColumn">
            <ul class="footerServicesBullets">
                <li><span class="footerBoldTextServices">TRANSPORT</span></li>
        ...
        <div class="footerServicesColumn">
            <ul class="footerServicesBullets">
                <li><span class="footerBoldTextServices">VEHICLE REPAIR</span></li>
        ...
        <div class="footerServicesColumn">
            <ul class="footerServicesBullets">
                <li><span class="footerBoldTextServices">WELLNESS & PERSONAL GROOMING</span></li>
                ...
                <li><a class="footerServicesLink" href="#">Hair dressing & Make-up</a></li>
                <li><a class="footerServicesLink" href="#">Manicure & Pedicure</a></li>
                <li><a class="footerServicesLink" href="#">Massage</a></li>
            </ul>
        </div>
    </div>
    <div class="footerBottom">
        <div class="footerBottomColumn">
            <ul class="footerBottomBullets">
                <li><span class="footerBoldTextBottom">ABOUT ASSIST</span></li>
        ...
        <div class="footerBottomColumn">
            <ul class="footerBottomBullets">
                <li><span class="footerBoldTextBottom">CUSTOMER CARE</span></li>
                ...
                <li><a class="footerBottomLink" href="#">Contact Us</a></li>
            </ul>
        </div>
        <div class="footerBottomColumn">
            <ul class="footerBottomBullets">
                <li><span class="footerBoldTextBottom">COLLABORATE</span></li>
