        ...
        <div class="grid">
            ...
            <div class="item mb-4" style="border: 1px solid #E4E5E8">    
                    <div class="product font-rale pb-3 mx-2 bg-light">
                        <a href="<?php printf('%s?service_id=%s', 'product2.php',  $service['service_id']); ?>"><img src="<?php echo $service['service_image'] ?? "./assets/products/13.png"; ?>" style="height: 150px; width: 204px" alt="product1" class="img-fluid"></a>
