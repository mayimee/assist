            ...
            <form action="createaccount.php" method="POST"> 
                <div class="row">
                    ...
                    <div class="col-sm-6 mt-3 mb-3">
                        ...
                        <input type="number" name="contact_number" id="contact_number" placeholder="Contact Number" class="form-control" required>
                        <span class="error"><?php echo $contact_numberErr; ?> </span>
                    </div>
                    <div class="col-sm-6 mt-3 mb-3">
                        <label for="birthday" class="form-label">Birthday</label>
                        <input type="date" name="birthday" id="birthday" placeholder="Birthday" class="form-control" required>
                    </div>
                    ...
                    <div class="col-sm-6 mt-3 mb-3">
                        ...
                        <input type="password" name="confirm_password" id="confirmPassword" placeholder="Confirm Password" class="form-control" required> 
